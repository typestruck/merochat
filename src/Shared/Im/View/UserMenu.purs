...
userMenu model =
      HE.div (HA.class' { settings: true, highlighted: model.toggleModal == Tutorial OptionsMenu })
            ...
            , HE.div [ HA.class' "outer-user-menu" ]
                    [ SIS.home
                    , HE.svg [ HA.onClick <<< SpecialRequest $ ToggleModal (if model.smallScreen then ShowUserMenuModal else ShowProfile) , HA.class' "svg-32 svg-user-menu-context", HA.viewBox "0 0 50 50" ]
