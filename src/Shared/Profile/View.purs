...
edit model =
      ...
      , HE.div [HA.class' "profile-section"]
              ...
              , HE.textarea [ HA.class' "modal-input", HA.maxlength descriptionMaxCharacters, HA.rows 7, HA.value $ DM.fromMaybe "" model.descriptionInputed, onChange (SetAutoGenerated Description) ] [HE.text $ DM.fromMaybe "" model.descriptionInputed]
              ]
