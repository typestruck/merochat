...
changePassword loggedUserID password = SD.execute $ update users # set (_password /\ password) # wher (id .=. loggedUserID)

terminateAccount :: Int -> ServerEffect Unit
terminateAccount loggedUserID = SD.execute $ delete # from users # wher (id .=. loggedUserID) --cascades
