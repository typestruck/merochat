...
emojiButton model@{ toggleChatModal, smallScreen }
      ...
      | otherwise =
              HE.div (HA.class' "emoji-access-div") $ HE.svg [ HA.onClick $ ToggleChatModal ShowEmojis, HA.class' "emoji-access", HA.viewBox "0 0 16 16" ]
                    ...
                    , HE.path' [ HA.class' "strokeless", HA.d "M8,0a8,8,0,1,0,8,8A8,8,0,0,0,8,0Zm0,15.5A7.5,7.5,0,1,1,15.47,8,7.51,7.51,0,0,1,8,15.45Z" ]
                    , HE.path' [ HA.class' "strokeless", HA.d "M2.34,9.19l0,.15a5.77,5.77,0,0,0,11.19,0l0-.15ZM8,13.45a5.47,5.47,0,0,1-5.31-4H13.27A5.49,5.49,0,0,1,8,13.45Z" ]
                    ]
