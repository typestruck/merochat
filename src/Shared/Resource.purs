...
allowedMediaTypes = DH.fromFoldable <<< DA.zip [ "data:image/png;base64", "data:image/jpeg;base64", "data:image/tiff;base64", "data:image/bmp;base64", "data:image/gif;base64", "data:audio/webm;base64", "data:audio/mp4;base64", "data:video/mp4;base64" ] $ DS.toUnfoldable allowedExtensions
