...
view model = HE.div (show ProfileEditionForm)
      [ HE.div [ HA.class' { "profile-edition": true, hidden: not model.visible } ]
              ...
              , HE.div (HA.class' "profile-section")
                      ...
                      , HE.input [ HA.class' "modal-input", HA.type' "text", HA.value $ DM.fromMaybe "" model.nameInputed, HA.onChange' (SetAutoGenerated Name) ]
                      ]
              , HE.div (HA.class' "profile-section")
              ...
              , HE.div (HA.class' "profile-section")
                      ...
                      , HE.input [ HA.class' "modal-input", HA.type' "text", HA.placeholder "Enter to add" ]
                      ]
              , HE.div (HA.class' "profile-section")
              ...
              , HE.div (HA.class' "profile-section")
                      ...
                      , HE.textarea' [ HA.class' "modal-input", HA.type' "text" ]
                      ]
