...
setAutoGenerated model what raw =
      case what of
            ...
            Headline → model { headlineInputed = value, loading = value == Nothing } /\ [ generated (Proxy ∷ Proxy "headlineInputed") ]
            Description → model { descriptionInputed = value, loading = value == Nothing } /\ [ generated (Proxy ∷ Proxy "descriptionInputed") ]
      where
      value
            | DS.null raw = Nothing
            | otherwise = Just raw
