		...
		H.div [H.class' "landing"] [
	        	H.div [H.class' "green-area"] [
		        	...
		        	H.h1 [] [H.text "Friendly. Random. Chat. #melanchat"],
		            	H.h4 [] [H.text  "Create an account and chat right away with"],
	        ...
	        H.div [H.class' "blurb"] [
	            	...
	            	H.div [H.class' "orange-blurb"] [
	                	...
	                	H.div [H.class' "blurb"] [
							...
							H.a [H.href "https://en.wikipedia.org/wiki/Smalltalk"] [],
							H.text "conversation in mind. Talk to people, have actual interactions and make real friendships without fearing the dreaded ASL questions or getting stalked.",
							H.br [] [],
