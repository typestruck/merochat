...
tar -C /home/eduardo/Documents/merochat/ -c --zstd --exclude=file/upload package.json file/ output-es/ loader/server.js | ssh melanchat@46.101.109.141 -t "cd /home/melanchat && rm -rf build/ && mkdir build && cd build && tar -x --zstd" &&
