...
header model = SE.fragment
      [ HE.img [ HA.onClick avatarAction, HA.class' "avatar-settings", HA.src $ SA.fromAvatar model.user, HA.autoSize true, HA.title "Post to MeroChat" ]
