...
terms =
      HE.div (HA.class' "terms")
            ...
            , HE.p_ """These terms and conditions are the entire agreement between MeroChat ("the Site", "we", "our", "us") and the user of the Site ("you", "your")."""
            ...
            , HE.div (HA.class' "hide-internal")
                    ...
                    , HE.p_
                            ...
                            , HE.a (HA.href $ routes.help {} <> "#privacy") "https://mero.chat/privacy."
                            ]
                    ]
            , HE.h2_ "Limitations and liability"
            , HE.p_ """The Site is provided "as is" without any warranty. MeroChat nor any of its workers will be liable to any loss or damage related to the use, or inability to use, the Site."""
            ...
            , HE.p_
                    ...
                    , HE.a [ HA.href "https://github.com/typestruck/merochat/blob/master/LICENSE", HA.target "_blank" ] "https://github.com/typestruck/merochat/LICENSE."
                    ]
