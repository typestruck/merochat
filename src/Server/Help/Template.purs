      ...
      where
            content = [
                  HE.div (HA.class' "terms") [
                        ...
                        HE.h2_ "F.A.Q.",
                        HE.ul_ [
                              HE.li_ $ HE.a (HA.href "#whatsmelanchat") "What is MelanChat?",
                              ...
                              HE.li_ $ HE.a (HA.href "#other") "I have another question/doubt/something else to say"
                        ],
                        ...
                        HE.p_ "No. MelanChat is for friendly conversations only, there is already plenty of other places to try getting laid.",
                        HE.h2 [HA.id "canifilter"] "Is MelanChat free?",
                        HE.p_ [
                        ...
                        HE.h2 [HA.id "#"] "Recommend me some music",
                        HE.p_ [
                              HE.text "Listen to ",
