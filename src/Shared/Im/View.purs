...
view isClientRender model = HE.div [ HA.class' "im" ]
      [ HE.div (HA.class' { "contact-box": true, "current-mobile-screen": model.initialScreen })
              [ SIVU.userMenu model
              , HE.div [ HA.style { "white-space": "pre-wrap", "text-align": "center" }, HA.class' { "suggestion-box-error": true, flexed: model.smallScreen && (not $ DS.null model.errorMessage) } ] model.errorMessage
      ...
      , HE.div [ HA.class' { "suggestion-box": true, "current-mobile-screen": not model.initialScreen }, HA.onDragenter' PreventStop, HA.onDragover' PreventStop, HA.onDrop' DropFile ]
              [ HE.div [ HA.style { "white-space": "pre-wrap", "text-align": "center" }, HA.class' { "suggestion-box-error": true, flexed: not $ DS.null model.errorMessage }] model.errorMessage
